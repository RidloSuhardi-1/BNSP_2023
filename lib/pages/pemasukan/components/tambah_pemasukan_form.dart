...
class TambahPemasukanForm extends StatefulWidget {
  const TambahPemasukanForm({super.key});

  @override
  State<TambahPemasukanForm> createState() => _TambahPemasukanFormState();
}

class _TambahPemasukanFormState extends State<TambahPemasukanForm> {
  final _formKey = GlobalKey<FormState>();

  final String _jenisRiwayat = 'pemasukan';
